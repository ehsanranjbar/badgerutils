...
func (_m *MockIndexer[T]) Lookup(args ...any) (badgerutils.Iterator[[]byte, indexing.Chunk], error) {
	var _ca []interface{}
	_ca = append(_ca, args...)
	ret := _m.Called(_ca...)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(...any) (badgerutils.Iterator[[]byte, indexing.Chunk], error)); ok {
		return rf(args...)
	}
	if rf, ok := ret.Get(0).(func(...any) badgerutils.Iterator[[]byte, indexing.Chunk]); ok {
		r0 = rf(args...)
	} else {
		if ret.Get(0) != nil {
...
func (_c *MockIndexer_Lookup_Call[T]) Return(_a0 badgerutils.Iterator[[]byte, indexing.Chunk], _a1 error) *MockIndexer_Lookup_Call[T] {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockIndexer_Lookup_Call[T]) RunAndReturn(run func(...any) (badgerutils.Iterator[[]byte, indexing.Chunk], error)) *MockIndexer_Lookup_Call[T] {
	_c.Call.Return(run)
	return _c
}
